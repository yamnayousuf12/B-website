...
//     scrollYProgress,
//     [0, 0.5, 1],
//     ["#1565EB", "Blue/40", "#0e1755"] // Blue → Purple → Pink
//   );
...
//     <section
//       ref={containerRef}
//       className="relative min-h-screen bg-black text-white px-8 md:px-20 py-6 flex flex-col md:flex-row md:gap-12 gap-14 overflow-hidden"
//     >
//       <div
//         className="absolute -inset-16 -z-1 bg-cover bg-center bg-no-repeat h-full w-full"
//         style={{ backgroundImage: "url('/Hstats.png')" }}
//       />

//       {/* Left Floating Panel */}
//       <motion.div className="md:w-1/2 flex flex-col z-10">
//         <h1 className="text-xl md:text-4xl font-bold mb-2">From Spark to Software</h1>
//         <p className="text-white/85 md:text-lg text-sm">Bitsframe Dev Journey</p>
//       </motion.div>

//       {/* Right Timeline */}
//       <motion.div className="md:w-1/2 relative pr-4">
//         <div className="absolute md:left-24 left-28 md:top-0 top-16 bottom-0 w-1 bg-white/10" />
...
//               {/* Animated Dot */}
//               <motion.div
//                 className="absolute -left-6 md:top-3 top-8 w-4 h-4 rounded-full border shadow-md animate-pulse"
//                 style={{
//                   backgroundColor,
//                   borderColor,
//                 }}
...
//               {/* Animated Card */}
//               <motion.div
//                 className="rounded-lg md:px-6 md:py-4 px-1 py-2 md:w-full w-44 md:max-w-sm max-w-xs md:mt-16 mt-14"
//                 style={{
