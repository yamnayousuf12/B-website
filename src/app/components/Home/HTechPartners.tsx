      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 md:gap-6">
          {brands.map((brand, index) => (
            <div
              key={index}
              className="w-[100px] h-[50px] md:w-[180px] md:h-[70px] flex items-center justify-center text-xs md:text-base font-light text-gray rounded-md bg-[#0f0f0f] border border-[#1a1a1a] shadow-[0_0_30px_rgba(255,255,255,0.03)] hover:bg-[#1c1c1c] transition-all duration-300"
            >
              {brand}
            </div>
          ))}
