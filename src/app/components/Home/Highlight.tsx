...
const Highlight: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Main Sentence */}
      <h2 className="text-[12px] md:text-2xl text-gradient font-medium leading-relaxed md:max-w-3xl max-w-64 mb-5 ">We make it easy for companies and their employees to setup, contribute to and manage complex benefits
