...
>
      ...
      <div className="relative z-10 max-w-4xl mx-auto ml-6 ">
        <h1 className="text-2xl font-extrabold md:text-3xl mb-4 text-justify text-white ">
        ...
        <p className="text-sm md:text-lg font-light mb-4 text-white/80">From building a secure cloud system as our first project to working with international companies, we are always trusted and appreciated. Over these years, we have helped unlimited clients achieve their goals.</p>
        <p className="text-sm md:text-lg font-light mb-2 text-white/80">We have had a real impact, from small entrepreneurs seeking IT solutions for small businesses to international enterprises. We are trusted by 22+ brands internationally and within our beloved country, Pakistan.</p>
         </div>
          </section>
  );
};
